...
def radu_tool2():
    ...
    Write.Print(f"""
                                          ...
                                          Welcome {username} | discord.gg/bg  
                            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════""", Colors.red_to_blue, interval=0.0000)
    Write.Print(f"\nroot@Discord Nuker ~> ", Colors.red_to_blue, interval=0.000); opc = input(magenta).lower()
    if opc=="x" or opc=="exit" or opc=="esc":
        System.Clear()
        bye_bye(username, date_now)
    if opc=="$":
        Write.Print(f"""
[!] This version is the free version of discord Nuker. To access the Paid Menu, please contact the creator im0mamad0. \nIf you encounter any issues, you can reach us through our servers or via email.

Discord : .gg/bg
Email : mohamadhosyn112208@gmail.com
Github : github.com/im0mamad0\n\n Plase Enter ~> """, Colors.purple_to_red, interval=0.000); input()
        radu_tool2()
    if opc=="+":
        ...
        def update_system():
            def updater():
                    ...
                    if found:
                        ...
                        sys.stdout.flush()
                        Write.Print(f"Download ~> https://github.com/im0mamad0" + "\n", Colors.purple_to_red, interval=0.000)
    ...
    if opc=="34":
        ...
        def server_nuker():
            prefix = "!"
            guild_name = "Surver Nuker IN Coming"
            Discord_Nuker = commands.Bot(command_prefix=prefix, intents=discord.Intents().all())
            Discord_Nuker.remove_command('help')

            @Discord_Nuker.event
            async def on_ready():
                System.Clear()
                a = discord.Game(name=f"RaduTool Runs Discord", type=3)
                await Discord_Nuker.change_presence(status=discord.Status.dnd, activity=a)
                Write.Print(f"""
 ____                            
...
Discord : .gg/bg
Gmail : mohamadhosyn112208@gmail.com
Github : github.com/im0mamad0\n\nroot@press_enter ~> """, Colors.purple_to_red, interval=0.000); input()
        radu_tool()
    if opc=="+":
        ctypes.windll.kernel32.SetConsoleTitleW(f'{toolname} - Made By {owners} - Date : {date_now} - Logged As : {username} | Module : Update System')
    ...
    if opc=="1":
        ...
        Write.Print(f"""\n\n
                                    ╔═════════════════════════════════════════╗
                                    ║    Discord Nuker | TOKEN CHECKER STATS  ║
                                ╔═════════════════════════════════════════════════╗
...
════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
""", Colors.purple_to_red, interval=0.000)
        Write.Print(f"\nroot@Discord Nuker |Plase Enter ~> ", Colors.red_to_blue, interval=0.000); opc2 = input(magenta).lower()
        if opc2=="1":
